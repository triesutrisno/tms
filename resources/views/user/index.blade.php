    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
            <div class="clearfix">
                    <a href="{{url('/user')}}" class="btn btn-white btn-primary btn-bold">
                            <i class="ace-icon fa fa-folder-open-o bigger-120 blue"></i>
                            Lihat Data
                    </a>
                    <a href="{{url('/user/create')}}" class="btn btn-white btn-success btn-bold">
            ...
            <div class="col-sm-12 col-md-10">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <form action="{{ url('/user')}}" method="head">
                        @csrf
                            <!-- text input -->
          ...
          <table id="example1" class="table table-bordered table-hover">
            <thead>
              <tr class="bg-light-blue-gradient">
                ...
                <th width="290">Nama User</th>
                <th>Email</th>
                <th width="150" align="center">Created</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$dt->name}}</td>
                    <td>{{$dt->email}}</td>
                    <td align="center">{{$dt->created_at}}</td>
                    <td align="center">
                        @if($dt->status == '1')
                    ...
                    <td>
                        <div class="hidden-sm hidden-xs action-buttons">
                            <a class="green" href="{{ url('/user')}}/{{$dt->id}}/edit"><i class="ace-icon fa fa-pencil bigger-130"></i></a>                                                                                                
                            <form action="{{ url('/user')}}/{{$dt->id}}" method="post" class="inline hapus">
                                @method('delete')
                                @csrf
