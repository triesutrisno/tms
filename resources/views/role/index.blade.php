    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
            <div class="clearfix">
                    <a href="{{url('/role')}}" class="btn btn-white btn-primary btn-bold">
                            <i class="ace-icon fa fa-folder-open-o bigger-120 blue"></i>
                            Lihat Data
                    </a>
                    <a href="{{url('/role/create')}}" class="btn btn-white btn-success btn-bold">
            ...
            <div class="col-sm-12 col-md-10">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <form action="{{ url('/role')}}" method="head">
                        @csrf
                            <!-- text input -->
                ...
                <tr>
                    ...
                    <td>
                        <div class="hidden-sm hidden-xs action-buttons">
                            <a class="green" href="{{ url('/role')}}/{{$dt->role_nama}}/edit"><i class="ace-icon fa fa-pencil bigger-130"></i></a>                                                                                                
                            <form action="{{ url('/role')}}/{{$dt->role_nama}}" method="post" class="inline hapus">
                                @method('delete')
                                @csrf
